...
itembtn2 = types.KeyboardButton('Коллектив')
...
@bot.message_handler(func=lambda message: message.text=='Коллектив')
def collegues(message):
    bot.send_message(message.chat.id, 'Наш дружный коллектив')
